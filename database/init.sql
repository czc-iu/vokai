...
('体验版', '适合个人用户试用', 10000, 9.90, 19.90, 30, '["1万tokens额度", "30天有效期", "基础模型支持"]', FALSE, 1),
('基础版', '适合轻度使用用户', 50000, 39.90, 59.90, 90, '["5万tokens额度", "90天有效期", "全部模型支持", "优先响应"]', FALSE, 2),
('专业版', '适合中度使用用户', 200000, 129.90, 199.90, 180, '["20万tokens额度", "180天有效期", "全部模型支持", "优先响应", "专属客服"]', TRUE, 3),
